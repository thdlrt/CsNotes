...
- $M-VaR_i=\Phi^{-1}(c)\frac{\mathrm{cov}(R_i,R_A)}{\sigma_A}=\frac{VaR_A}{P_0}\cdot\frac{\mathrm{cov}(R_i,R_A)}{\sigma_A^2}=\frac{VaR_A}{P_0}\cdot\beta_{i,A}$
...
- **成分 $VaR$**：C-VaR
- 从投资组合中删除某成分（资产 $i$）组合 VaR 的的近似变化量 $C-VaR_i=M-VaR_i\cdot P_{0,i}$
