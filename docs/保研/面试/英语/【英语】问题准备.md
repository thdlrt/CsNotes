...
I wrote most of the game’s code, including character behaviors, path tracer, and unit AI. The codebase was over 4000 lines and involved complex logic. I used design patterns like Singleton[ˈsɪŋɡ(ə)ltən] and Strategy to organize the project.
