...
2. **Syntax Analysis**:
    - The tokens are analyzed according to the grammatical[ɡrəˈmætɪkl] rules of the programming language.
...
3. **Semantic Analysis**:
    ...
    - Symbol tables are constructed and the syntax tree is annotated[ˈænəteɪtɪd] with type information.
