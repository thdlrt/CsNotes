...
- <img src="https://thdlrt.oss-cn-beijing.aliyuncs.com/image-20240327164556224.png" alt="image-20240327164556224" style="zoom: 25%;" />
...
- 先把数组分块，然后把查询的区间按左端点所在**块号**进行排序，块号相同时按右端点进行排序
