...
- SDF表示**一个点到一个曲面的最小距离**，同时用正负来区分点在曲面内外。**点在曲面内部则规定距离为负值，点在曲面外部则规定距离为正值，点在曲面上则距离为0**.
- 二维 SDF：圆
	- ![image.png|380](https://thdlrt.oss-cn-beijing.aliyuncs.com/undefined20241212121400.png)
